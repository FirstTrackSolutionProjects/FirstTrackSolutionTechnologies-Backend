...
const sendCandidateSubmissionEmail = ({ firstName, email }) => {
  return {
    from: process.env.HR_EMAIL,
    to: email,
    ...
    html: `
      <div style="font-family: Arial, sans-serif; color: #333; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px;">
        ...
        <p>Thank you for filling out the Join Us form. We have received your response successfully.</p>
        <p>Our team will review your submission and get back to you if any further information is required.</p>
        <br>
        <p>Best regards,<br><strong>First Track Solution Technologies Team</strong></p>
        <hr>
